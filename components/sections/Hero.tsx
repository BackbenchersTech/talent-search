...
export const Hero = ({ title, description }: { title: string; description: string }) => {
  return (
    <div className='w-full text-center'>
      ...
      <p className='mx-auto mt-[1.5rem] max-w-[400px] text-gray-800'>{description}</p>

      <div className='mt-6 flex w-full flex-row items-center justify-center gap-4 text-[15px]'>
        <Link
          href='/explore'
