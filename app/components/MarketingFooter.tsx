...
const Branding = () => (
  <div className='flex flex-col justify-between'>
    <div>
      ...
      <div className='mt-1 lg:mt-1.5 flex flex-row items-center text-sm gap-0.5'>
        <svg
      ...
      <div className='flex flex-row gap-5 text-gray-400 max-lg:mt-6'>
        ...
        <Link href='https://www.x.com'>
          ...
          <svg
            ...
            fill='currentColor'
            stroke='currentColor'
            className='size-5 hover:text-gray-600 duration-200 aspect-square'
          >
...
const FooterSection = ({
  ...
  <>
    <div className={`font-medium text-[15px] mb-2 ${titleClassName}`}>
      {title}
    </div>
    <div className='flex flex-col gap-1'>
      {links.map(({ label, href }) => (
        <Link
          key={href}
          href={href}
          className='text-left text-gray-600 text-[15px] hover:text-gray-500 duration-100'
        >
          {label}
        </Link>
      ))}
  ...
  return (
    <div className='w-full'>
      <div className='w-full py-8 sm:py-12 md:py-20'>
        ...
        <div className='max-lg:mt-6 grid grid-cols-2 sm:grid-cols-4 gap-4 text-black'>
